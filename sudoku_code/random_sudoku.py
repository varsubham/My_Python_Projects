import random
class generating_random_sudoku:
...
class random_sudoku_display:
	def __init__(self, solved_grid):
		self.solved_grid=solved_grid
	def new_sudoku(self, solved_grid):
		difficulty_level=40
		...
		while(k<=difficulty_level):
			...
			final_grid[rand_index[0]][rand_index[1]]=self.solved_grid[rand_index[0]][rand_index[1]]
